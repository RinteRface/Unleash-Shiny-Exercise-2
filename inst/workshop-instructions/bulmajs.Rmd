...
2. Run `create_js_hanlder("modal")` in the R console. Rename the newly created R script to `toggle_bulma_modal` and modify it according to the below code chunk. It has 2 parameters: `id` for the target (not mandatory), and session is the current session extracted with `shiny::getDefaultReactiveDomain`. Fill in the blanks! 
