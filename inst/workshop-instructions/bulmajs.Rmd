...
3. Edit the `add_bulmajs_deps` function to add an extra dependency containing the local reference to `bulma-modal.js`. Below is the corresponding dependency to copy. Hint: `hasClass` may help you to check the current modal class!
